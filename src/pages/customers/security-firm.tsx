...
const SecurityFirmCaseStudyPage: React.FC = () => {
    ...
    return (
        <Layout isMobile={isMobile}>
            <Box width="100%" sx={{ backgroundColor: theme.palette.gray.darkGrayOffset, py: 3, borderRadius: '8px', textAlign: 'start' }}>
                <Box mx={3}>
            ...
            <Box my={4}>
                ...
                <Typography variant="body1" color={gray.gray6} mb={2}>
                    Jack&apos;s team runs exclusively on Google Cloud Platform. As is common, every ML workload they run links
                    together multiple stages — loading data, cleaning and featurizing it, generating predictions, post-processing
                    and sanity-checking them, publishing, and so on.
                </Typography>
                    
                <Typography variant="body1" color={gray.gray6} mb={2}>
                    Prior to adopting Aqueduct, Jack was forced to string together many different cloud services to run each 
                    ML pipeline &mdash; each pipeline required customer configuration to handle storage, scheduling, 
                    asynchronous execution, and distribution. Each stage was deployed as a separate function on 
                    Google Cloud Functions. 
                </Typography>

                <Typography variant="body1" color={gray.gray6} mb={2}>
                    Within this web of services, execution needed to be pipelined through asynchronous queues. With many 
                    opaque services strung together this was the best way to make sure the majority of the data was processed.
                </Typography>

                <Typography variant="body1" color={gray.gray6} mb={2}>
                    If and when anything broke in this pipeline — e.g., an expired API token or an unexpected data 
                    point &mdash; the whole pipeline would fail, and Jack would have little to no context around what failed 
            ...
            <Box my={4}>
                <Box width="fit-content" mb={4}>
                    ...
                    <Typography variant="body1" color={gray.gray6} mb={2}>
                        The ability to quickly develop and test pipelines &mdash; combined with the visibility into pipeline 
                        execution and errors Aqueduct provides — convinced Jack to move into production.Within a couple of weeks, 
                        Jack was comfortable with Aqueduct, and <b>he was able to reduce the time needed to build, test, and 
                        deploy new ML pipelines from 4-6 weeks to 1 week</b>.
                    </Typography>

                    <Typography variant="body1" color={gray.gray6} mb={2}>
                        With Aqueduct, the biggest performance gain was from processing one data point at a time through a 
                        microservice queue to batch processing the full dataset; this also simplified Jack&apos;s code.
                    </Typography>

                    <Typography variant="body1" color={gray.gray6} mb={2}>
                        Today, with workflows running on Aqueduct, Jack saves about an hour of his time every day. Previously, 
                        he would be spending his time picking through each workflow to ensure it worked as expected; now, 
                        at a glance, Aqueduct gives him confidence that all his pipelines are working.
                    </Typography>

                    <Typography variant="body1" color={gray.gray6} mb={2}>
                        As his company expands globally, Jack plans to support geographic constraints by building many lightweight, 
                        easily configurable, and region-specific workflows on Aqueduct. Across all these workflows, he gets the 
                        same visibility and confidence that everything works as expected.
                    </Typography>
                </Box>
            </Box>
        </Layout>
