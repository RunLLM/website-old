    ...
    return (
        <Layout isMobile={isMobile}>
            <Typography variant="h2" fontWeight="bold" textAlign="center" component="h1">
                Untangle the&nbsp;
                <GradientTypography variant="h2" fontWeight="bold" display="inline">
                    MLOps Knot
                </GradientTypography>
            </Typography>
            ...
            <Box mt={4} sx={{ maxWidth: '800px', textAlign: 'center', mx: 'auto' }}>
                ...
                <Typography variant="body1" color="white">
                    This leads to delays in development cycles and wasted resources, ultimately making it hard for
                    businesses to deliver on the value of machine learning.
                </Typography>
            </Box>
            ...
            <Box mt={10}>
                <Box sx={{ mx: 'auto', justifyContent: 'center' }}>
                    <Typography component="h2" variant="h3" fontWeight="bold" textAlign="center">
                        Aqueduct:&nbsp;
                        {isMobile && <br />}
                        <GradientTypography component="span" variant="h3" fontWeight="bold" textAlign="center">
                ...
                >
                    <Box flex={1} display="flex" justifyContent="center" mb={isMobile ? 2 : 0}>
                        <img
                            src="/product/dev-to-production.png"
                            height={isMobile ? '' : '125px'}
                            width={isMobile ? '100%' : ''}
                            alt=""
                        />
                    </Box>
                    ...
                    <Box width={isMobile ? '100%' : '65%'} mr={3}>
                        <Typography color={gray.gray8} mb={1} variant="h6">
                            From Dev to Production with Python
                        </Typography>
                        ...
                        <Typography variant="body1">
                            ...
                            configs or repetitive Dockerfiles. Aqueduct also automatically captures and recreates your
                            environment (Python version, library dependencies, etc.) in the cloud, so you don&apos;t
                            have to spend time debugging configuration issues or library version mismatches.
                        </Typography>
                    </Box>
                </Paper>
                ...
                >
                    ...
                    <Box width={isMobile ? '100%' : '65%'} mr={3}>
                        <Typography color={gray.gray8} mb={1} variant="h6">
                            Run Seamlessly on your Existing Infrastructure
                        </Typography>
                ...
                >
                    ...
                    <Box width={isMobile ? '100%' : '65%'} mr={3}>
                        <Typography color={gray.gray8} mb={1} variant="h6">
                            Deep Visibility into Pipeline Metadata
                        </Typography>
                        ...
                        <Typography variant="body1">
                            ...
                            code and data at each step of the pipeline which helps ensure accuracy and speed up
                            debugging. Aqueduct also enables you to define metrics and checks that continuously measure
                            and validate your pipelines, so you can have peace of mind knowing that you have complete
                            control.
                        </Typography>
                    </Box>
                </Paper>
                ...
                >
                    ...
                    <Box width={isMobile ? '100%' : '65%'} mr={3}>
                        <Typography color={gray.gray8} mb={1} variant="h6">
                            Your data, secure in your cloud
                        </Typography>

                        <Typography variant="body1">
                            With Aqueduct&apos;s open-source orchestration layer, you can be confident that all your
                            code and data remain within your cloud. Furthermore, Aqueduct automates credential
                            management by providing a unified way to access sensitive keys instead of having them
                            scattered around in your code.
                        </Typography>
                    </Box>
                </Paper>
            </Box>
                ...
                <Grid container spacing={5} mt={3}>
                    <Grid item xs={isMobile ? 12 : 4}>
                        ...
                        <Typography variant="body1" color={gray.gray8} mt={1}>
                            Use Aqueduct to create cloud resources on the fly. Get access to Kubernetes and Spark
                            clusters when you need them &mdash; in your cloud!
                        </Typography>
                    </Grid>
                    ...
                    <Grid item xs={isMobile ? 12 : 4}>
                        ...
                        <Typography variant="body1" color={gray.gray8} mt={1}>
                            Construct workflows that define their task graph at execution time for highly scalable tasks
                            like hyperparameter search.
                        </Typography>
                    </Grid>
