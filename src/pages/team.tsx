...
const TeamCard: React.FC<TeamCardProps> = ({ key, imgPath, name, title, bio }) => {
    ...
    return (
        <Grid
            ...
            px={3}
            sx={{
                background: displayBio ? gray.gray11 : 'transparent',
                position: displayBio ? 'static' : 'relative',
                borderRadius: '4px',
            }}
        >
            <Box onMouseOver={() => setDisplayBio(true)} onMouseOut={() => setDisplayBio(false)}>
            ...
            <Box display="flex" flexDirection="column" alignItems="center">
                ...
                <Box sx={{ maxWidth: '800px', my: 4 }}>
                    <Typography variant="h6" textAlign="center" my={3}>
                        Aqueduct was founded in 2020 by a team of Berkeley Computer Science professors and PhDs. We
                        believe that running machine learning in the cloud is simply too difficult. This infrastructure
                        complexity is drastically cutting the impact machine learning could have.
                    </Typography>
